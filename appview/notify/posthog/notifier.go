...
func (n *posthogNotifier) NewPullClosed(ctx context.Context, pull *db.Pull) {
	err := n.client.Enqueue(posthog.Capture{
		DistinctId: pull.OwnerDid,
		Event:      "pull_closed",
		Properties: posthog.Properties{
...
func (n *posthogNotifier) NewString(ctx context.Context, string *db.String) {
	err := n.client.Enqueue(posthog.Capture{
		DistinctId: string.Did.String(),
		Event:      "new_string",
		Properties: posthog.Properties{"rkey": string.Rkey},
...
func (n *posthogNotifier) NewIssueComment(ctx context.Context, comment *db.IssueComment) {
	err := n.client.Enqueue(posthog.Capture{
...
func (n *posthogNotifier) NewIssueClosed(ctx context.Context, issue *db.Issue) {
	err := n.client.Enqueue(posthog.Capture{
		DistinctId: issue.Did,
		Event:      "issue_closed",
		Properties: posthog.Properties{
...
func (n *posthogNotifier) NewPullMerged(ctx context.Context, pull *db.Pull) {
	err := n.client.Enqueue(posthog.Capture{
		DistinctId: pull.OwnerDid,
		Event:      "pull_merged",
		Properties: posthog.Properties{
