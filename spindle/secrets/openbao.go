...
func (v *OpenBaoManager) GetSecretsLocked(ctx context.Context, repo syntax.ATURI) ([]LockedSecret, error) {
...
func (v *OpenBaoManager) GetSecretsUnlocked(ctx context.Context, repo syntax.ATURI) ([]UnlockedSecret, error) {
	repoPath := v.buildRepoPath(repo)
...
func (v *OpenBaoManager) buildRepoPath(repo syntax.ATURI) string {
	// convert ATURI to a safe path by replacing special characters
...
func (v *OpenBaoManager) buildSecretPath(repo syntax.ATURI, key string) string {
